...
Если что-то в гайде потеряло актуальность, то воспользуйтесь обратной связью.

В саппорте мне ответили, что для смены даты регистрации в RETA необходимо отправить всего два документа — налоговый сертификат и требование от UGE.
